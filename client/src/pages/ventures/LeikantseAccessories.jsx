  ...
  return (
    <div className="relative min-h-screen bg-[#0F1115] text-white pt-32 pb-20 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Tech <span className="text-blue-500">Accessories</span></h1>
        <p className="text-white/60 mb-8 leading-relaxed">
          From fast chargers and protective cases to gaming peripherals — our accessory collection is being assembled. Expect quality and style.
        </p>
        <Link
...
export default LeikantseAccessories;
