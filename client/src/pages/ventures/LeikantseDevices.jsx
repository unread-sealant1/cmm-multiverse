...
import { Smartphone, ArrowRight, Clock } from "lucide-react";
import { Link } from "react-router-dom";

const LeikantseDevices = () => {
  return (
    <div className="relative min-h-screen bg-[#0F1115] text-white pt-32 pb-20 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Premium <span className="text-blue-500">Devices</span></h1>
        <p className="text-white/60 mb-8 leading-relaxed">
          Our device catalog is being curated. We will offer the latest smartphones, laptops, and certified refurbished gear at competitive prices.
        </p>
        <Link
...
export default LeikantseDevices;
