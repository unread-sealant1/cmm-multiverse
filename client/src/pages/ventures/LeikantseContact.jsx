  ...
  return (
    <div className="relative min-h-screen bg-[#0F1115] text-white pt-32 pb-20 flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4">Get in <span className="text-blue-500">Touch</span></h1>
        <p className="text-white/60 mb-8 leading-relaxed">
          Our dedicated support team will be available soon via WhatsApp, email, and phone. For now, stay tuned for launch updates.
        </p>
        <Link
...
export default LeikantseContact;
